...
In order to support loading of multiple wallets in safecapital-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is safecapital.cpp.
...
Changes to safecapital.cpp
----------------------
safecapital.cpp is the entry point into safecapital-qt, and as such, will require some minor modifications to provide hooks for
