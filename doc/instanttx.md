...
This mechanism has been integrated into Bitcore-Node-SafeCapital which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SafeCapital-Project/insight-api-safecapital#web-socket-api](https://github.com/SafeCapital-Project/insight-api-safecapital#web-socket-api) 
* API: [https://github.com/SafeCapital-Project/insight-api-safecapital#instantsend-transactions](https://github.com/SafeCapital-Project/insight-api-safecapital#instantsend-transactions) 
...
By default, the SafeCapital Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SafeCapital Core daemon:
