Contributing to SafeCapital Core
============================

The SafeCapital Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SafeCapital Core project, and is not to be
confused with overall SafeCapital Network Protocol consensus changes.

Whether a pull request is merged into SafeCapital Core rests with the project merge
...
Patches that change SafeCapital consensus rules are considerably more involved than
...
Where a patch set proposes to change the SafeCapital consensus, it must have been
...
The project leader is the release manager for each SafeCapital Core release.
