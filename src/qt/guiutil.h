...
/** Utility functions used by the SafeCapital Qt UI.
 */
namespace GUIUtil
{
...
// Render SafeCapital addresses in monospace font
...
// Parse "safecapital:" URI into recipient object, return true on successful parsing
