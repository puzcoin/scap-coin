...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SafeCapital Core"),
     ...
     * override -datadir in the safecapital.conf file in the default data directory
     * (to be consistent with safecapitald behavior)
     */
    if (dataDir != getDefaultDataDirectory())
