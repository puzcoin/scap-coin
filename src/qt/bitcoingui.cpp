                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SafeCapital Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SafeCapital address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and safecapital: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SafeCapital Core"), this);
    aboutAction->setStatusTip(tr("Show information about SafeCapital Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SafeCapital"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SafeCapital addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SafeCapital addresses"));
    ...
    openAction->setStatusTip(tr("Open a SafeCapital: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SafeCapital Core help message to get a list with possible SafeCapital command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SafeCapital Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SafeCapital network", "", count));
}
...
{
    QString strTitle = tr("SafeCapital Core"); // default title
