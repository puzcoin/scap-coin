...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SafeCapital Core safecapital-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  safecapital-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded safecapital transaction") + "\n" +
                               "  safecapital-tx [options] -create [commands]   " + _("Create hex-encoded safecapital transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded safecapital transaction
